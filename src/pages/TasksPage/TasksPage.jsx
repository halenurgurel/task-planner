...
import { selectAllTasks, selectIsLoading } from "../../redux/tasks/selectors";
import { useNavigate } from "react-router-dom";
import { fetchTasks, toggleTaskStatus } from "../../redux/tasks/operations";
...
const TasksPage = () => {
  ...
  return (
    <div className="mx-auto flex w-full max-w-100 flex-col items-center gap-5 rounded-xl bg-white p-6 shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
